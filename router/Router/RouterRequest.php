...
class RouterRequest
{
	 ...
	 * @return	mixed
	 */
    public static function reqData($index = NULL, $xss_clean = FALSE)
    {
        return Self::_fetch_from_array($_REQUEST, $index, $xss_clean,true);
	}
	 ...
	 * @return	mixed
	 */
	private static function _fetch_from_array(&$array=[], $index = NULL, $xss_clean = FALSE,$fromHTTP_X=false)
	{
		// Lets do this to check for put and delete request
		// ================================================
		if(True === $fromHTTP_X){
			$array = $array ?: [];
			// gets the request method
			$method = $_SERVER["REQUEST_METHOD"];
			// If the method is POST and HTTP_X_HTTP_METHOD exist within $_SERVER global variable (i.e the type of POST is either DELETE OR PUT)
